...
public class ModuleController extends BaseController {
    ...
    public BaseDataResponse select(@RequestBody ModuleQuery query){
        DomainPage page = moduleService.findModulePage((ModuleDaoQuery) query.asQuery(ModuleDaoQuery.class));
        if (page==null||page.getDomains()==null||page.getDomains().isEmpty()) {
            return BaseDataResponse.noData();
        }else{
            List<ModuleForm> moduleForms= (List<ModuleForm>) page.getDomains().stream()
